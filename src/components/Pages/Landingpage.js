...
const InfoPage = () => {
  ...
  <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-950 flex items-center justify-center px-6 py-20">
    <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-10 md:p-16 w-full max-w-4xl text-center transition-transform transform hover:scale-[1.03] duration-300">
      <h1 className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-orange-500 via-cyan-400 to-teal-400 mb-4 animate-fade-in-down">
        Welcome to
      </h1>
      ...
      <div className="mb-10">
        <SignedOut>
          <SignInButton mode="modal">
            <button className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-orange-700 to-indigo-600 hover:from-orange-600 hover:to-indigo-700 text-white font-medium py-3 rounded-xl shadow-lg transition-all transform hover:scale-105 duration-300">
        ...
        <SignedIn>
          <button
            ...
            className="w-full bg-orange-500  hover:from-green-600 hover:to-teal-600 text-white font-semibold py-3 rounded-xl shadow-lg transition-all transform hover:scale-105 duration-300"
          >
            Get Started
          </button>
        </SignedIn>
      ...
      <p className="text-sm text-gray-400">
        ...
        <span className="text-orange-400 hover:underline cursor-pointer">Terms</span> and{" "}
