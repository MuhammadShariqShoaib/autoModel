...
const modules = [ 
  ...
  },
  {
    ...
    route: '/ChatSupportBlog', // Route for the module
  },
  {
    id: 3,
    ...
    route: '/ThreeDModelBlog', // Route for the module
  },
];
    ...
    <Navbar/>
      ...
      >
        ...
        <div className="relative z-10 text-white w-full max-w-5xl p-8 text-center">
          ...
          <a
            href="/sample.docx" // Path to the Word file
            download="Sample.docx" // This ensures the file is downloaded
            className="px-6 py-3 bg-green-600 text-white text-lg rounded-lg shadow-lg hover:bg-blue-700 transition duration-300"
          >
            Documentation
          </a>
        </div>
