    ...
    >
      <div className="bg-gray-900 bg-opacity-75 min-h-screen">
        ...
        <footer className="text-center py-8 mt-12">
          {/* <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg m-2 shadow-md">
            Login with Google
          </button> */}
          <Link to='/Get-Started'>
          <button  className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg m-2 shadow-md">
            Get Started
          </button>
          </Link>
        </footer>
